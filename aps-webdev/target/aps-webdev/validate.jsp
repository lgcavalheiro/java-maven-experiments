...
<html> 
    ...
    <body> 
        ...
        --%> 
        <jsp:useBean id="snr" class="main.java.Validate"/> 
          
        <%-- Set the value of the created bean using form data --%>  
        <jsp:setProperty name="snr" property="senha"/> 
          
        <%-- Display the form data --%> 
        The Details Entered Are as Under<br/> 
        <p>Password : <jsp:getProperty name="snr" property="senha"/></p> 
          
        <%-- Validate the user using the validate() of  
             ValidateUser.java class 
        --%> 
        <%if(snr.validate("pinguim")){%> 
